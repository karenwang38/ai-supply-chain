...
const COMPANIES = {
  ...
  "6488.TW": {
    ...
    layer: 0, category: "底層特殊材料晶圓",
    badge: "台灣矽光子材料核心",
    tagline: "台灣半導體材料鏈重要環節",
    overview: "環球晶是台灣最大矽晶圓廠，全球市佔約 17%，為台灣矽光子材料供應核心。近年積極切入 SiC（碳化矽）晶圓市場，受益於電動車與 AI 資料中心電源管理需求。",
    technology: {
      core: "CZ法矽晶圓、SiC 晶圓技術",
      products: ["300mm 矽晶圓", "200mm/150mm 矽晶圓", "SiC 基板（碳化矽）"],
      advantages: ["台灣本土供應鏈優勢，與台積電地緣接近", "SiC 晶圓布局早，搶佔電動車材料先機"]
    },
    marketShare: { global: "~17%", desc: "全球第三大矽晶圓廠，台灣最大", competitors: ["信越化學", "SUMCO", "Siltronic"] },
    customers: { major: ["台積電", "聯電", "日月光", "英飛凌（SiC）"], breakdown: "台灣半導體客戶為主，SiC 部分切入歐洲車用半導體廠" },
    outlook: { positive: ["SiC 晶圓市場2025-2030年複合成長率30%+", "台灣 AI 供應鏈需求拉動"], catalysts: ["SiC 產能擴充進度（美國德州廠）"] },
    stockMetrics: {
      divYield: "0%"
    },
    challenges: ["SiC 擴產資本支出龐大，良率提升挑戰", "與中國競爭者（天科合達等）的價格戰"],
    risks: ["SiC 需求若受電動車銷量不如預期影響", "收購 Siltronic 失敗後的策略調整"]
  },
...
make-or-break 事件 = 2026 Q4 量產良率公告。`,
  ...
  "4919.TW": {
    ...
    customers: {
      major: [
        { name: "廣達", note: "AI 伺服器代工最大客戶，GB200 機架 BMC 主要供應", pct: "~35%" },
        { name: "緯穎", note: "超大規模 AI 伺服器代工，BMC/BMS 採購", pct: "~20%" },
        { name: "SuperMicro（美超微）", note: "美系 AI 伺服器品牌商，BMC 直採", pct: "~20%" },
        { name: "儲能 / BBU 廠商", note: "資料中心電池備援模組，BMS 晶片", pct: "~15%" },
        { name: "工控/車用", note: "NTCJ 日本晶圓廠傳統客群", pct: "~10%" },
      ],
      breakdown: "AI 伺服器代工三雄（廣達、緯穎、鴻海）是最大客戶群，透過他們間接服務微軟、Amazon、Google。BB U 儲能市場是第二成長曲線，直接受益 AI 資料中心強制導入不斷電系統需求。"
    },
    outlook: {
      positive: [
...
▌ 轉機本質
傳統 MCU/鍵盤控制器廠 → AI 資料中心「千手觀音」
關鍵比喻：沒有 BMC 幫伺服器看門、沒有 BMS 幫電池看電壓，再強的 NVIDIA 晶片也無法在資料中心安全跑起來。

▌ 兩條護城河
1. BMC 晶片（全球第二，20-25% 市佔）
   傳統伺服器每機架 10-20 顆 → AI 伺服器每機架 80-120 顆
   成長倍數：6-8 倍

2. BMS 晶片（源自日本松下半導體技術）
   AI 資料中心強制導入 BBU 電池備援模組
   高壓 BMS 壁壘深厚，競爭者短期難複製

▌ 財務轉折關鍵數字
• 2025 全年 EPS：-3.97 元（虧損底部）
• 2026 Q1 EPS：+0.02 元（扭虧為盈轉折點）
• 2026 Q1 毛利率：39.3%（前季 34.3%，單季暴衝 5 個百分點）
• 2026/04 調漲 6 吋代工報價 20%（定價權回歸）
• 2026 全年 EPS 法人預估：4.5-5.2 元
• 最新股價（2026/05/22）：199.5 元（爆量漲停）

▌ 冷酷觀察（業外水分警告）
2026 Q1 扭虧很大程度靠業外收入（員工留任條件達成收益等）
本業（營業利益）其實還在微幅虧損邊緣
→ 下半年本業 BMC/BMS 出貨必須實質兌現，才是真正的基本面確認

▌ 估值特性
屬標準「爆發型轉機股」，PEG 不適用（2025 基期虧損）
市場買的是從虧損彈回大賺的「估值修復期」
類似邏輯：Sivers（SIVE）從瑞典小盤冷門股 → AI 國防雙護城河重估

▌ 核心風險
🔴 信驊（Aspeed）70% 壟斷 BMC 市場，新唐只能打客製化差異化
🔴 日本晶圓廠（NTCJ）稼動率若再下滑，折舊黑洞重現
🟡 GB200 出貨若再延遲，Q3 業績預期落空
🟡 業外收入一次性，Q2 本業必須自立`,
    challenges: [
