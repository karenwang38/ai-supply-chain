...
• 旺矽在晶圓級 Burn-in 市場的份額佈局進度`,
  ...
  "3595.TW": {
    ...
    overview: "山太士早期聚焦 LCD 面板背光模組光學材料裁切加工，近年完成策略性質變：逐步淡出傳統低毛利光電市場，全面轉型為「半導體先進封裝與測試材料」專業供應商。核心競爭力在於大面積膜材的塗佈、黏著配方與快速客製化開發能力。過去被日系大廠（3M、日東電工、住友電工）壟斷的高階製程化學膜材，山太士憑藉本土供應鏈的超高配合度，成功打入一線半導體與封測巨頭，在 AI 浪潮中交出高成長營收成績單。",
    products: {
      core: "探針卡清潔片（清針片）、抗翹曲膠膜、雷射解膠層、FOPLP 材料、晶背研磨膠帶（BGBM Tape）",
      list: [
        "探針卡清潔片（清針片）：AI 晶片測試剛性耗材，維持探針精準度必備，隨 AI 測試需求暴增大量放量出貨",
        "抗翹曲膠膜（Anti-warpage Film）：大面積先進封裝應力支撐，防止晶片因熱漲冷縮翹曲報廢",
        "雷射解膠層（Laser Release Layer）：暫時鍵合/解鍵合（Temporary Bonding / Debonding）製程核心膜材，透過雷射完美分離載板與晶片",
        "FOPLP 材料：扇出型面板級封裝，利用大面積面板歷史技術順理成章跨入「由圓轉方」FOPLP 與玻璃基板封裝材料，一線大廠驗證完成並出貨",
        "晶背研磨膠帶（BGBM Tape）：晶圓背面研磨保護膜，支援後續背面金屬化製程"
      ]
    },
    technology: {
      moat: [
        "大面積薄膜塗佈配方技術（源自 LCD 面板歷史積累，直接轉化 FOPLP 超大基板優勢）",
        "客製化快速配方開發能力（台廠一站式服務，日系大廠無法快速回應的本土替代壁壘）",
        "探針卡清潔片：高黏著精準配方，複購率高、客戶黏著度強的剛性耗材護城河",
        "雷射解膠層：對雷射波長高度敏感的精準配方，進入門檻極高"
      ],
      trend: "先進封裝材料國產化替代加速（日系供應鏈風險意識升高）；AI 晶片 Warpage 問題隨晶片面積極大化持續惡化，材料解決方案需求強勁"
    },
    customers: [
      { name: "一線封測廠", note: "日月光、京元電等，先進封裝膜材與測試耗材雙線供應" },
      { name: "晶圓代工廠生態", note: "FOPLP / TGV 玻璃基板先進封裝製程材料，一線大廠驗證完成出貨" },
      { name: "高階測試座廠", note: "穎崴等高頻測試環境探針卡清潔片需求" }
    ],
    outlook: [
      "AI 晶片面積極大化 → Warpage 問題更嚴峻 → 抗翹曲膠膜 ASP 與量同步提升",
      "CoWoS / FOPLP 先進封裝快速滲透 → 雷射解膠層需求線性正成長",
      "FOPLP 由圓轉方長期趨勢：大面積塗佈歷史技術優勢直接轉化，已取得一線大廠驗證出貨",
      "探針卡清潔片：AI 晶片測試量暴增，高複購率剛性耗材壁壘持續強化",
      "日系大廠國產替代：3M、日東電工、住友電工份額逐步被侵蝕，山太士是主要受益者"
    ],
    stockMetrics: {
      exchange: "TWSE",
      currency: "TWD",
      sector: "先進封裝材料",
      peers: ["日東電工", "住友電工", "3M 半導體材料部門"]
    },
    notes: `【山太士（3595）轉型分析備忘】2026/06
從「LCD 裁切廠」→「半導體先進封裝材料軍火庫」的策略質變

● 轉型核心邏輯：
  舊業務（LCD 背光模組裁切）：消費電子景氣循環，毛利率受壓，長期式微
  新業務（半導體先進封裝材料）：AI 算力驅動的結構性成長，客戶黏著度高，日系替代空間大

● 三大核心產品分析：

1. 探針卡清潔片（清針片）
  → 測試廠剛需耗材，單價不高但量穩定、複購率極高
  → AI 晶片測試量非線性成長直接帶動出貨量暴增
  → 關鍵客戶：京元電、日月光、穎崴等高頻測試環境

2. 先進封裝膜材（抗翹曲 + 雷射解膠層 + FOPLP 材料）
  → 最高毛利潛力區
  → 抗翹曲：AI 晶片面積極大化，翹曲問題日趨嚴峻，精準配方高壁壘
  → 雷射解膠層：暫時鍵合製程化學核心，日系主導但在地化替代進行中
  → FOPLP：「由圓轉方」長期趨勢，山太士大面積塗佈技術直接轉化，已完成一線驗證

3. 晶背研磨膠帶（BGBM Tape）
  → 晶圓變薄製程保護性耗材，與先進封裝製程深度綁定

● 估值觀察重點：
  ✦ 毛利率趨勢（轉型進度指標：是否擺脫低毛利光電業務重量）
  ✦ 先進封裝材料佔比（目標 >70% 營收來自半導體）
  ✦ FOPLP/TGV 驗證廠商數量（下一波成長引擎）
  ✦ 日系大廠替代速度（3M / 日東電工份額轉移時間軸）`
  },
